...
reasoning. Code, the frozen protocol, raw run logs and all analysis scripts are available at
\url{https://github.com/waleed-u/when-does-homophily-help}.
\end{abstract}
...
by hand. Code, the frozen protocol (git tag \texttt{protocol-freeze}), raw logs, and all
analysis and figure scripts are available at \url{https://github.com/waleed-u/when-does-homophily-help}.
